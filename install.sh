...
echo ""
echo "CLI Mode:"
echo "  python3 currency_converter.py 100 usd"
echo "  python3 currency_converter.py 1000 inr"
echo "  python3 currency_converter.py --help"
echo ""
echo "For Homebrew installation and more information, see README.md"
